...
const About = () => {
  return (
   ...
   <div className='shadow-md shadow-sky-400 my-5 '>
    <div className='py-4 max-w-2xl mx-auto '>I'm a third year undergratuate pursuing B.tech in information technology from Harcout Butler Technical University.I have a keen interset in problem solving,data structure and algorithms (dsa) and in web developement.</div>
   </div>
   <div className='flex justify-center items center gap-x-4  '>
    <Link href='https://app.enhancv.com/resume/63021b5ed72d03004dee9f97'>
