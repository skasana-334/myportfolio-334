...
import contactimg from '../public/exp/contactimg.jpg'
      ...
      <div id='contact me' className='w-full'>
       ...
       <div className='flex flex-col md:flex-row gap-8 mt-4 shadow-lg shadow-blue-400'>
        <div className='w-full md:w-1/2 h-full rounded-xl p-4 mt-4 flex flex-col'>
            <Image src={contactimg} width='450' height='300 ' className='rounded-2xl'/>
            <p className='text-2xl pt-2 pb-3'>I am open to talk regarding internships or full-time opportunities.Feel free to contact me using your preferred medium.</p>
